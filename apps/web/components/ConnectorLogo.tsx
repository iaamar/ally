...
export type ConnectorLogoId = 'codex' | 'claude' | 'cursor' | 'manual';

interface ConnectorLogoProps extends SVGProps<SVGSVGElement> {
  id: ConnectorLogoId;
  size?: number;
}
...
export function ConnectorLogo({
  ...
  if (id === 'codex') {
    return (
      <svg {...shared} aria-hidden="true" focusable="false">
        <path
